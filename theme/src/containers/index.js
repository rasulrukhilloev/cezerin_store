	...
	return (
		<Fragment>
			...
			<section className="advantages section-container">
				<h2 className="advantages__title section__title">Преимущества</h2>
			...
			<section className="contacts section-container">
				<h2 className="contacts__title_content section__title">Контакты</h2>
				<div className="contacts__content">
					<LazyLoad>
						<HomeContacts settings={settings} />
					</LazyLoad>
				</div>
				<h2 className="contacts__title_map section__title">Карта</h2>
